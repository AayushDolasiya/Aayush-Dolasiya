      ...
      <div className="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 relative z-10">
        ...
        <div className="relative flex justify-center items-center w-full min-h-[500px] lg:min-h-full z-10 order-1 lg:order-2 -mt-12 sm:-mt-16 md:-mt-24 lg:-mt-150 xl:-mt-72">
          ...
          <motion.div
            ...
            className="absolute bottom-[100px] md:bottom-30 lg:bottom-50 xl:bottom-180 z-30 bg-[#161d18] w-[90%] md:w-[350px] p-6 rounded-2xl shadow-2xl border border-white/5"
          >
