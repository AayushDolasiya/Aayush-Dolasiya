      ...
      <div className="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 relative z-10">
        ...
        <div className="relative flex justify-center items-center w-full min-h-[500px] lg:min-h-full z-10 order-1 lg:order-2 -mt-12 sm:-mt-16 md:-mt-24 lg:-mt-[510px] xl:-mt-[530px]">
          ...
          <motion.div
            ...
            className="absolute bottom-[20px] md:bottom-[-40px] lg:bottom-[-40px] xl:bottom-[-60px] z-30 bg-[#161d18] w-[90%] md:w-[350px] p-6 rounded-2xl shadow-2xl border border-white/5"
          >
